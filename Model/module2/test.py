...
args_dict = {
    'cuda': False,  # or False depending on your preference
    'generator_A2B': '/content/drive/MyDrive/model_istda_lgsn/netG_A2B.pth'
}
...
with torch.no_grad():
    ...
    opt.dataroot_A = '/content/drive/MyDrive/GTAV/Test/extra_shadow_1'
    opt.im_suf_A = '.jpg'
    ...
    for idx, img_name in enumerate(gt_list):
        ...
        save_result = join_paths('/content/drive/MyDrive/AISTD/LGSN/B_copy/%s' % (img_name + opt.im_suf_A))
